...
botui.message
  ...
  .then(() => {
    ...
    else if (perc > 45 && perc < 75)
      msg =
        "There is a slight possibility that you may be Corona positive. You should have a checkup!";
    else if (perc <= 45) msg = "Chill! You are alright. Enjoy!";

    document.getElementById("result").innerHTML = ` 
  <div class="jumbotron" style="font-family: 'Gotu', sans-serif; background-color: #202020; color:white; font-size:28px;font-weight:900; text-align:center;">
